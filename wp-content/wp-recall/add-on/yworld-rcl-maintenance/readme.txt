...
3. После активации Yworld RCL Maintenance сайт будет закрыт на обслуживание для всех кроме админа.

== FAQ ==
* Нужно деактивировать дополнение после окончания работ?
Да, обязательно деактивировать, о чем вам будет напоминать сообщение в админке.

  Демострация работы дополнения и сайт поддержки <a href="https://asgarosforum.ru/community/">Пример работы Yworld PF Ticker</a>
