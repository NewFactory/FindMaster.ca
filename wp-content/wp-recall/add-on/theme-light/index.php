...
if (!is_admin()):
	...
	add_action('rcl_enqueue_scripts','rcl_replace_fontawesome',10);
endif;

function rcl_replace_fontawesome(){   
    rcl_enqueue_style('cab_lineawesome', 'https://maxcdn.icons8.com/fonts/line-awesome/1.1/css/line-awesome-font-awesome.min.css' );
}

function rcl_cab_15_scripts(){   
    rcl_enqueue_style('cab_15',rcl_addon_url('light-style.css', __FILE__));
}
