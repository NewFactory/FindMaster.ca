...
== FAQ ==
<h3>Настройки есть?</h3>
- настроек нет


<h3>Что надо для работы?</h3>
1. Активированное дополнение чата: <a href="https://codeseller.ru/products/rcl-chat/" target="_blank">RCL-Chat</a> (базовое дополнение WP-Recall)
1.1 Создаем любой глобальный чат на странице, используя шорткод <a href="https://codeseller.ru/api-rcl/rcl-chat/" target="_blank">rcl-chat</a>
2. Активируем дополнение автобота - <a href="https://codeseller.ru/products/autobot-cabinet/" target="_blank">AutoBot Cabinet</a> (версии не менее v2.0) и настраиваем его согласно инструкции (вкладка "Настройки")

- после этого, на странице созданного общего чата, появляются над формой ввода сообщения необходимые кнопки.


<h3>Не активируется дополнение. Что не так?</h3>
- должен быть активирован доп <a href="https://codeseller.ru/products/autobot-cabinet/" target="_blank">AutoBot Cabinet</a>
