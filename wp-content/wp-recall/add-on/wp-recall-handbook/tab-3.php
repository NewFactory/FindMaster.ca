...
<div class="wprh_blk tab_3">
    <h2>Видеоматериалы по плагину WP-Recall и его дополнениям:</h2>

    <div class="tab_3_blk">
        <span>Промо ролик о плагине к 15.1 версии:</span>
        <iframe width="680" height="415" src="https://www.youtube.com/embed/vXVKI8Ie0lY" frameborder="0" allowfullscreen></iframe>
    </div>

    <div class="tab_3_blk">
        <span>Установка и первоначальная настройка плагина Wp-Recall:</span>
        <iframe width="680" height="415" src="https://www.youtube.com/embed/-ZMmmN0GXJw" frameborder="0" allowfullscreen></iframe>
    </div>

    <div class="tab_3_blk">
        <span>Основы работы с дополнениями Wp-Recall:</span>
        <iframe width="680" height="415" src="https://www.youtube.com/embed/7Anx5u5MX88" frameborder="0" allowfullscreen></iframe>
    </div>

    <div class="tab_3_blk">
        <span>Установка функционала групп Wp-Recall:</span>
        <iframe width="680" height="415" src="https://www.youtube.com/embed/9AbKr4rVi6k" frameborder="0" allowfullscreen></iframe>
    </div>

    <div class="tab_3_blk">
        <span>WP-Recall. Организация интернет-магазина.<br/> Урок 1:</span>
        <iframe width="680" height="415" src="https://www.youtube.com/embed/93q7me5zsnE" frameborder="0" allowfullscreen></iframe>
    </div>

    <div class="tab_3_blk">
        <span>WP-Recall. Организация интернет-магазина.<br/> Урок 2:</span>
    ...
    <span>Плагины и другие дополнения к плагину Wp-Recall:</span>
    <br/>

    <div class="tab_3_blk">
        <span>Плагин <a title="Перейти к дополнению" href="https://codeseller.ru/products/plagin-posts-filter-generator-konstruktor-proizvolnyx-form-dlya-poiska-i-filtracii-zapisej-wordpress/">Posts Filter Generator</a> - создание поискового фильтра:</span>
        <iframe width="680" height="415" src="https://www.youtube.com/embed/EZFU7x_Mns4" frameborder="0" allowfullscreen></iframe>
    </div>

    <div class="tab_3_blk">
        <span>Демонстрация работы дополнения <a title="Перейти к дополнению" href="https://codeseller.ru/products/sale-downloads-recall-prodazhi-fajlov-i-cifrovyx-tovarov-na-sajte/">Sale Downloads Recall</a>:</span>
        <iframe width="680" height="415" src="https://www.youtube.com/embed/oMfNkDZrvmo" frameborder="0" allowfullscreen></iframe>
    </div>

    <div class="tab_3_blk">
        <span>Публикация задания на <a title="Перейти к дополнению" href="https://codeseller.ru/products/vasha-frilans-birzha-na-wordpress/">фриланс-бирже</a> и работа по нему:</span>
        <iframe width="680" height="415" src="https://www.youtube.com/embed/Q1aUpn8axF0" frameborder="0" allowfullscreen></iframe>
    </div>
