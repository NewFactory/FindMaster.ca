...
3. После активации Yworld Schema Article, в меню настроек WP-Recall перейти к пункту Schema Article и произвести необходимые установки.
 
== FAQ ==
* Какой тип разметки выбрать?
  Если не уверены в выборе, оставляйте Article.
  
* Какие картинки указывать?
  Можете указать с логотипом, будут выводится при отстуствие картинке записи. Размеры указаны.
  
  * Показывает ошибки в Яндекс валидаторе микроразметки?
  <a href="https://worldwebinfo.ru/community/dopolneniya-ot-yworld/yworld-schema-article/" target="_blank">Тут есть решение</a>
 
== Changelog ==
* 1.0.3 
 Description заполнится выдержкой из контента в 25 слов, даже если вы не заполняете "Отрывок".

* 1.0.0 
 Начальная версия
 
 == Иформация ==
 <a href="https://asgarosforum.ru/projects/">Все мои дополения</a>