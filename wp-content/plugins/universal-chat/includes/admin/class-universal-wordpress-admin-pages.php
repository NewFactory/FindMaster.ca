 ...
 * Universal Connector.
 *
 * @package   Universal_Connector_Admin_Pages
...
class Universal_Connector_Admin_Pages
{
    ...
    public function enqueue_admin_css_js()
    {
        ...
        // Main Plugin Page
        if ($this->plugin_screen_hook_suffix['universal_wordpress'] == $screen->id) {
            /* Admin Styles */
    ...
    public function add_plugin_admin_menu()
    {
         ...
         *
         */
        $this->plugin_screen_hook_suffix['universal_wordpress'] = add_menu_page(
            __('Universal Chat', 'universal-wordpress'),
            __('Universal Chat', 'universal-wordpress'),
            'manage_options',
            $this->plugin_slug . '-main-page',
            array($this, 'display_plugin_page_main'),
            CHAT_HOST . '/images/icon.png'
        );
