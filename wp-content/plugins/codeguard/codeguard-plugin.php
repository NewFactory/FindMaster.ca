...
if ( ! function_exists( 'cg_plugin_action_links' ) ) {
	...
	function cg_plugin_action_links( $links, $file ) {
		...
		if ( $file == $this_plugin ) {
			$settings_link = '<a href="' . admin_url() . 'admin.php?page=amazon-s3-backup">Settings</a>';
...
function cg_toolbar_link( $cg_wp_admin_bar ) {
	$args = array(
		'id'    => 'codeguard',
		'title' => 'CodeGuard',
		'href'  => '' . admin_url() . 'admin.php?page=amazon-s3-backup',
		'meta'  => array(
			'class' => 'codeguard',
			'title' => 'CodeGuard',
		),
	...
	$args = array(
		...
		'href'   => '' . admin_url() . 'admin.php?page=codeguard-support',
		'parent' => 'codeguard',
		'meta'   => array(
