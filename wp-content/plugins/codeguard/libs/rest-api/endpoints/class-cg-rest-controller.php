...
class CG_REST_Controller extends WP_REST_Controller {
	...
	public function register_api_routes() {
		...
		register_rest_route(
			$namespace, 'plugins/status', array(
				'methods'             => 'GET',
		...
		register_rest_route(
			$namespace, 'plugins/upgrade', array(
				'methods'             => 'GET',
		...
		register_rest_route(
			$namespace, 'themes/upgrade', array(
				'methods'             => 'GET',
		...
		register_rest_route(
			$namespace, 'backup', array(
				'methods'             => 'GET',
				'callback'            => array( $this, 'backup' ),
				'permission_callback' => array( $this, 'can_backup' ),
			)
		);
	}
