    ...
    function shopical_ocdi_files()
    {
        ...
        return apply_filters('aft_demo_import_files', array(
            array(
                ...
                'import_file_name' => esc_html__('Shopical Pro Default', 'shopical'),
                ...
                'preview_url' => 'https://demo.afthemes.com/shopical-pro/',
            ),

            array('import_file_name' => esc_html__('Gadgets Pro', 'shopical'),
                ...
                'preview_url' => 'https://demo.afthemes.com/shopical-pro/gadgets-pro/',
            ),
            array('import_file_name' => esc_html__('Automobile Pro', 'shopical'),
                ...
                'preview_url' => 'https://demo.afthemes.com/shopical-pro/automobile-pro/',
            ),
...
if (!function_exists('shopical_fonts_url')):
    ...
    function shopical_fonts_url()
    {
        ...
        $shopical_primary_font = shopical_get_option('primary_font');
        $shopical_secondary_font = shopical_get_option('secondary_font');

        $shopical_fonts = array();
        $shopical_fonts[] = $shopical_primary_font;
        $shopical_fonts[] = $shopical_secondary_font;

        $i = 0;
        for ($i = 0; $i < count($shopical_fonts); $i++) {

            if ('off' !== sprintf(_x('on', '%s font: on or off', 'shopical'), $shopical_fonts[$i])) {
                $fonts[] = $shopical_fonts[$i];
            }
...
function shopical_scripts()
{
    ...
    wp_enqueue_style('jquery-countdown', get_template_directory_uri() . '/assets/countdown/jquery.countdown.css');
    ...
    wp_enqueue_script('owl-carousel-thumbnails', get_template_directory_uri() . '/assets/owl-carousel-v2-thumbs/src/owl.carousel2.thumbs.js', array('jquery', 'owl-carousel'), '', true);
    ...
    wp_enqueue_script('jquery-countdown', get_template_directory_uri() . '/assets/countdown/jquery.countdown.js', array('jquery'), '', true);
