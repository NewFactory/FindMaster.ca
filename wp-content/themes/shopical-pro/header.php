...
<div id="page" class="site">
    ...
    <?php if (is_active_sidebar('above-top-header-section')): ?>
        <section id="above-top-header-section-wrapper" class="above-top-header section">
            <?php
        ...
        <?php if (class_exists('WooCommerce')) : ?>
            ...
            if ($show_main_banner_section):
                ...
                if ($show_latest_product_section):
                    if ($frontpage_main_banner_layout != 'main-banner-style-5'):
                ...
                <section class="main-banner-section-wrapper container-wrapper">
                    ...
                    if ($frontpage_main_banner_layout == 'main-banner-style-2') {
                        shopical_get_block('2', 'main-banner');
                    } elseif ($frontpage_main_banner_layout == 'main-banner-style-3') {
                        shopical_get_block('3', 'main-banner');
                    } elseif ($frontpage_main_banner_layout == 'main-banner-style-4') {
                        shopical_get_block('4', 'main-banner');
                    } elseif ($frontpage_main_banner_layout == 'main-banner-style-5') {
                        shopical_get_block('5', 'main-banner');
                    } else {
                        shopical_get_block('1', 'main-banner');
                    }
            ...
            <div class="aft-tertiary-background-color">
                ...
                $show_offer_pages_section = shopical_get_option('show_offer_pages_section');
                if ($show_offer_pages_section):

                    ?>

                    <section class="bottom-page-grid container-wrapper">
                        <?php
                        shopical_get_block('page-grid', 'section');
                        ?>
                    </section>
                <?php endif; ?>
                ...
                $show_featured_product_section = shopical_get_option('show_featured_product_section');
                if ($show_featured_product_section):

                    ?>


                    <section class="featured-product-section product-section-wrapper container-wrapper">
                        <?php
                        shopical_get_block('featured-product', 'section');
                        ?>
                ...
                $show_onsale_product_section = shopical_get_option('show_onsale_product_section');
                if ($show_onsale_product_section):

                    ?>
                    <section  class="onsale-product-section product-section-wrapper container-wrapper aft-product-list-mode">

                        <?php
                        shopical_get_block('onsale-product', 'section');
                        ?>
                    </section>
                <?php endif; ?>
