...
<?php do_action('shopical_action_full_width_upper_footer_section'); ?>
        ...
        <div class="container-wrapper">
            <div class="site-info-wrap">
                ...
                if (!empty($shopical_secure_payment_badge)):
                    ...
                    $shopical_open_on_new_tab = shopical_get_option('secure_payment_badge_open_in_new_tab');
...
<?php
$scroll_to_top_position = shopical_get_option('footer_scroll_to_top_position');
$scroll_to_top_icon = shopical_get_option('footer_scroll_to_top_icon');
?>
