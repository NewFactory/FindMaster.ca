...
<head>
    ...
    <title><?php _e( 'Product Comparison', 'shopical' ) ?></title>
...
<h1>
    ...
    <?php if ( ! $is_iframe ) : ?><a class="close" href="#"><?php _e( 'Close window [X]', 'shopical' ) ?></a><?php endif; ?>
</h1>

<div id="yith-woocompare" class="woocommerce aft-yith-compare-table-wrap">
    ...
    <?php if ( empty( $products ) ) : ?>
        ...
        <tr class="no-products">
            <td><?php _e( 'No products added in the compare table.', 'shopical' ) ?></td>
        </tr>
        ...
        <tr class="remove">
            ...
            foreach( $products as $product_id => $product ) :
                ...
                <td class="<?php echo $product_class; ?>">
                    <a href="<?php echo add_query_arg( 'redirect', 'view', $this->remove_product_url( $product_id ) ) ?>" data-product_id="<?php echo $product_id; ?>"><?php _e( 'Remove', 'shopical' ) ?> <span class="remove">x</span></a>
                </td>
                <?php
                ++$index;
            endforeach;
