    ...
    class Shopical_Store_Author_Info extends AFthemes_Widget_Base
    {
        ...
        public function form($instance)
        {
            ...
            if (isset($categories) && !empty($categories)) {
                ...
                echo parent::shopical_generate_text_input('shopical-author-info-linkedin', __('LinkedIn', 'shopical'), '');
                echo parent::shopical_generate_text_input('shopical-author-info-vk', __('VK', 'shopical'), '');
