...
if (!class_exists('Shopical_Store_Call_to_Action')) :
    ...
    class Shopical_Store_Call_to_Action extends AFthemes_Widget_Base
    {
        ...
        public function widget($args, $instance)
        {
            ...
            $date = isset($instance['shopical-call-to-action-date']) ? $instance['shopical-call-to-action-date'] : '';
            $message = isset($instance['shopical-call-to-action-message']) ? $instance['shopical-call-to-action-message'] : '';
                    ...
                    <div class="inner-call-to-action">
                        <div class="suscribe">
                            <div class="offer-main">
                                ...
                                <?php if (!empty($date)): ?>
                                    <span class="offer-date-counter">
                                    <?php
                                    $strtotime = strtotime($date);
                                    $newformat = date('Y-m-d', $strtotime);
                                    ?>

                                        <div id="countdown" class="aft-schedule-date-countdown"
                                             data-date="<?php echo esc_attr($newformat); ?>"
                                             data-message="<?php echo esc_attr($message); ?>"></div>
                                        <div class="aft-schedule-note-section"></div>
                                        <input type="hidden" name="aft-day-singular" value="<?php _e('day', 'shopical'); ?>">
                                        <input type="hidden" name="aft-day-plural" value="<?php _e('days', 'shopical'); ?>">
                                        <input type="hidden" name="aft-hour-singular" value="<?php _e('hour', 'shopical'); ?>">
                                        <input type="hidden" name="aft-hour-plural" value="<?php _e('hours', 'shopical'); ?>">
                                        <input type="hidden" name="aft-minute-singular" value="<?php _e('minute', 'shopical'); ?>">
                                        <input type="hidden" name="aft-minute-plural" value="<?php _e('minutes', 'shopical'); ?>">
                                        <input type="hidden" name="aft-second-singular" value="<?php _e('second', 'shopical'); ?>">
                                        <input type="hidden" name="aft-second-plural" value="<?php _e('seconds', 'shopical'); ?>">
                                        <input type="hidden" name="aft-and-text" value="<?php _e('and', 'shopical'); ?>">
        ...
        public function form($instance)
        {
            ...
            echo parent::shopical_generate_text_input('shopical-call-to-action-date', 'Schedule date', '', 'text', 'Enter date in yyyy-mm-dd format', 'shopical-call-to-action-date');
            echo parent::shopical_generate_text_input('shopical-call-to-action-message', 'Schedule Message', '');
