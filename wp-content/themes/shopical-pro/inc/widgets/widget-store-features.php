    ...
    class Shopical_Store_Features extends AFthemes_Widget_Base
    {
        ...
        function __construct()
        {
            $this->text_fields = array(
                ...
                'shopical-store-features-4-icon',
                'shopical-store-features-4-title',
                'shopical-store-features-4-desc',
            );
        ...
        public function form($instance)
        {
            ...
            echo parent::shopical_generate_section_title('shopical-store-features-4', 'Store Features 4');
            echo parent::shopical_generate_text_input('shopical-store-features-4-icon', 'Icon', 'fa fa-repeat');
            echo parent::shopical_generate_text_input('shopical-store-features-4-title', 'Title', '30 Days Returns');
            echo parent::shopical_generate_text_input('shopical-store-features-4-desc', 'Descriptions', '30 days money back');
        }
    }
endif;