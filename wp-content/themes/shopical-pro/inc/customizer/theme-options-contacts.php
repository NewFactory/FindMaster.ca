...
$wp_customize->add_setting('store_contact_website',
    array(
        ...
        'capability'        => 'edit_theme_options',
        'sanitize_callback' => 'shopical_url_sanitization',
    )
);
$wp_customize->add_control('store_contact_website',
    array(
        'label'    => esc_html__('Store Website', 'shopical'),
        'section'  => 'store_contact_settings',
        'type'     => 'text',
        'priority' => 130,
    )
...
$wp_customize->add_control('store_contact_other_informations',
    array(
        'label'    => esc_html__('Other Information', 'shopical'),
        'section'  => 'store_contact_settings',
        'type'     => 'textarea',
        'priority' => 130,
    )
...
/*store_contact_form*/
$wp_customize->add_setting('store_contact_map',
    array(
        'default'           => $default['store_contact_map'],
        'capability'        => 'edit_theme_options',
        'sanitize_callback' => 'sanitize_text_field',
    )
);
$wp_customize->add_control('store_contact_map',
    array(
        'label'    => esc_html__('Address Map Shortcode', 'shopical'),
        'section'  => 'store_contact_settings',
        'type'     => 'text',
        'priority' => 130,
        //'active_callback' => 'store_contact_map_status'
