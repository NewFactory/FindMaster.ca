    ...
    function shopical_add_brand_fields() {
        ...
        <div class="form-field term-thumbnail-wrap">
            ...
            <div style="line-height: 60px;">
                ...
                <button type="button" class="upload_image_button button"><?php _e( 'Upload/Add image', 'shopical' ); ?></button>
                <button type="button" class="remove_image_button button"><?php _e( 'Remove image', 'shopical' ); ?></button>
            </div>
            <div class="clear"></div>
        </div>
        <?php
