...
function shopical_get_vertical_list_categories($categories_section_mode = 'show-top-5-products', $product_count = 'true', $onsale_product_count = 'true')
{
    ...
    if ($categories_section_mode == 'show-nested-subcategories') {
        return shopical_list_categories_dropdown(0, $product_count, $onsale_product_count);
    } elseif ($categories_section_mode == 'show-subcategories-and-products') {
        return shopical_list_categories_mega_list(0, $product_count, $onsale_product_count);
    } else {
